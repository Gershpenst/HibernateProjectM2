...
mysql -uroot -p
Mdp: <password>
CREATE DATABASE PROJETM2 CHARACTER SET utf8;
exit
...
Changez la valeur de la variable "value" pour la property name="password" en mettant votre vrai mot de passe root: <property name="password" value="<password>" />
...
NB: J'ai essayé de créer un utilisateur qui possède tout les privilèges de root mais je ne parviens pas à connecter ma base de donnée avec celui-ci. Je pense que seul root permet de se connecter à la base de donnée (ce qui est étrange).
